...
<head>
    ...
    <title>@yield('title') - Stevand Gurkha</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<center style="width: 100%;  text-align: left;">
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;"
        ...
        <tr>
            <td bgcolor="#ffffff">
                <img src="{{ asset('img/logo.gif') }}" width="400" height="" border="0" align="center"
                     style="width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 20px;" class="g-img">
            </td>
        </tr>
