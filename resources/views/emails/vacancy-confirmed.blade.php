...
@section('title', 'Vacancy Confirmed')

@section('inbox-preview')
    The vacancy has been confirmed for {{ $vacancy->company->name }}.
@stop
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600"
        ...
        <tr>
            <td bgcolor="#ffffff"
                ...
                <p><b>Hello,</b></p>
                <p>The email has been generated automatically to inform you that the vacancy <b>{{ $vacancy->company->name }}</b> has been confirmed.</p>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                            ...
                            <br>{{ route('vacancy.show' , $vacancy->id ) }}
                        </td>
                    </tr>
                </table>
            </td>
