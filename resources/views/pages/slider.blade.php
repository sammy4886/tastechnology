<!--Slider Here-->
<section class="dart-pt-0 dart-pb-0">
            ...
            <div id="rev_slider_1174_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-3238" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('images/transparent.png')}}" data-bgcolor="#f9f9f9" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-10"
                             ...
                             style="z-index: 7;border-width:0px;"><img src="{{asset('images/header_papers.png')}}" alt="" data-ww="['900px','900px','900px','900px']" data-hh="['1000px','1000px','1000px','1000px']" width="900" height="1000" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-12"
                             ...
                             style="z-index: 8;border-width:0px;"><img src="{{asset('images/header_marker.png')}}" alt="" data-ww="['200px','200px','200px','200px']" data-hh="['300px','300px','300px','300px']" width="200" height="300" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-11"
                             ...
                             style="z-index: 9;border-width:0px;"><img src="{{asset('images/header_edding.png')}}" alt="" data-ww="['300px','300px','300px','300px']" data-hh="['400px','400px','400px','400px']" width="300" height="400" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-12"
                             ...
                             style="z-index: 10;border-width:0px;"><img src="{{asset('images/header_paperclip.png')}}" alt="" data-ww="['50px','50px','50px','50px']" data-hh="['100px','100px','100px','100px']" width="50" height="100" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-11"
                             ...
                             style="z-index: 11;border-width:0px;"><img src="{{asset('images/header_paperclip.png')}}" alt="" data-ww="['50px','50px','50px','50px']" data-hh="['100px','100px','100px','100px']" width="50" height="100" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-9"
                             ...
                             style="z-index: 12;border-width:0px;"><img src="{{asset('images/header_tablet.png')}}" alt="" data-ww="['730px','730px','730px','730px']" data-hh="['520px','520px','520px','520px']" width="730" height="520" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-11"
                             ...
                             style="z-index: 13;border-width:0px;"><img src="{{asset('images/header_pen.png')}}" alt="" data-ww="['300px','300px','300px','300px']" data-hh="['500px','500px','500px','500px']" width="300" height="500" data-no-retina> </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                             ...
                             data-frames='[{"from":"y:-50px;rX:-45deg;sX:2;sY:2;opacity:0;","speed":1500,"to":"o:1;","delay":2940,"ease":"Power4.easeOut"},{"delay":"wait","speed":600,"to":"y:30px;rX:45deg;sX:0.8;sY:0.8;opacity:0;","ease":"Power2.easeInOut"}]'
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                             ...
                             style="z-index: 17; white-space: nowrap; font-size: 20px; line-height: 20px; font-weight: 400; color: rgba(68, 68, 68, 1.00);font-family:Roboto;border-width:0px;">Smart, Practical and cost-effective IT Solutions</div>

                        <!-- LAYER NR. 14 -->
                        <div class="tp-caption rs-parallaxlevel-3 btn btn-black btn-rounded btn-large"
                             ...
                             data-responsive_offset="on"
                             data-responsive="off"
                             data-frames='[{"from":"y:100px;rX:90deg;opacity:0;","speed":1500,"to":"o:1;","delay":700,"ease":"Power4.easeOut"},{"delay":"wait","speed":300,"to":"opacity:0;","ease":"nothing"},{"frame":"hover","speed":"150","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(255, 255, 255, 1.00);color:rgba(0, 0, 0, 1.00);"}]'
                             data-textAlign="['left','left','left','left']"
