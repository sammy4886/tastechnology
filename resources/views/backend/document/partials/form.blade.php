    ...
    <div class="col-sm-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="text-default-light">Download File</label>
                ...
                <div class="row">
                    ...
                    {{ Form::select('report',[ 'Downloads' => 'Downloads']) }}
                    </div>
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    ...
                    <input type="submit" name="draft" class="btn btn-info ink-reaction" value="Save Draft">
                    <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($document) && $document->is_published ? 'Save' : 'Publish' }}">
                </div>
            </div>
        </div>
    </div>
