...
xaxis, yaxis: {
    ...
    mode: null or "time" ("time" requires jquery.flot.custom.js plugin)
...
section. The time plugin (jquery.flot.custom.js) is required for time
series support.
...
jquery.flot.custom.js, for time series support.
